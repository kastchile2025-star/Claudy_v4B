...
class PromptsMixin:
    ...
    def _get_superpowers(self):
        ...
        return (
            ...
            "═══ PRIORIDAD DE FUENTES: LOCAL ANTES QUE INTERNET ═══\n"
            "Cuando la pregunta sea sobre algo de Felipe o de QCORE — sus PRODUCTOS\n"
            "(SmartStudent, Roadix, Point, Luxium, UnitCore, Mission Control,\n"
            "Campaign Studio, Mi Portafolio), sus clientes (Tentación a Granel,\n"
            "COMBAS), sus archivos, facturas, contratos, o cualquier proyecto suyo —\n"
            "el ORDEN OBLIGATORIO es:\n"
            "  1º Tu CONTEXTO ya inyectado (memoria, notas del vault de Obsidian,\n"
            "     contexto de producto activo y sus VERSIONES REALES EN DISCO).\n"
            "  2º Los archivos locales/Drive: usa /buscar_archivo y /leer sobre la\n"
            "     ruta del producto (las tienes en su contexto).\n"
            "  3º SOLO si nada de lo anterior responde, internet.\n"
            "Para «¿cuál es la última versión de <producto>?» la respuesta está en el\n"
            "bloque [VERSIONES REALES EN DISCO] de su contexto — ÚSALO, NO busques en\n"
            "internet. Internet NO sabe de los productos internos de QCORE.\n\n"
